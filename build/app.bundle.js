  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Title2.default, { title: 'Lista jest do dupy' })
      );
    }
  }]);
...
/*Objects are not valid as a React child (found: object with keys {}). If you meant to render a collection of children, use an array instead.
    in ul (created by TodoList)
    in TodoList (created by App)
...
app rend return	<List list={this.state.data} rem={this.removeTodo.bind(this)} />
*/
